# Plan 6/7: Web UI app.js (Markdown + Thinking Chain + Tool Visualization)

**Path:** `C:\Users\ab117\OneDrive\文件\OPENCODE\MCP\webui\app.js`
...
async function sendMessage() {
  ...
  const assistantMsg = { role: 'assistant', content: '', loading: true, thinking: '', sources: [], tools: {} };
  conversation.push(assistantMsg);
  setToolIndicator('processing', 'yellow');
  renderAndScroll();
